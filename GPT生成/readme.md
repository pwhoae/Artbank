...
### 立體圖片
```
以參考圖原有構圖為基礎，**保持中景與遠景的構圖、位置、比例、環境元素與空間關係基本不變**，僅強化整體景深與立體空間感。 採用「前景・中景・遠景」三層景深構圖： **【前景｜主要視覺焦點】** 以前景主體作為整張畫面的**絕對視覺中心與主要立體物件**，大幅強化前景的三維體積感、空間深度與視覺重量。主體具有清晰明確的輪廓、豐富細節、強烈明暗對比、立體光影與材質表現，突出表面結構、邊緣、凹凸、厚度與透視關係。使用近景透視放大效果，讓前景主體更加突出、具有壓迫感與沉浸感。**前景細節最清晰、對比最高、立體感最強，成為第一視覺焦點。** **【中景｜輔助層，保持不變】** **保持參考圖原有中景構圖與物件位置不變**，僅作為前景與遠景之間的自然過渡。保留原有結構、環境元素與空間線索，但降低細節密度與對比度，避免中景搶奪前景主體的視覺注意力。 **【遠景｜背景層，保持不變】** **保持參考圖原有遠景構圖、比例與主要環境元素不變**，作為宏大的背景空間。適度簡化遠景細節，降低清晰度、對比度與色彩飽和度，使用大氣透視、遠景霧化與空間色調衰減，營造遼闊的環境尺度與深遠距離感。 **【光影】** 光線從側後方斜向射入，形成明顯的輪廓光與側逆光，強化前景主體的邊緣、體積、厚度與立體結構。前景具有最強烈的光影層次，中景與遠景逐級降低對比，形成清晰的空間遞進。 **【最終視覺權重】** 前景 ＞ 中景 ＞ 遠景 **視覺焦點絕對集中於前景立體主體，中景與遠景不得搶焦。** 保持參考圖的中景、遠景構圖不變，主要提升前景主體的立體態感、體積感、透視感、材質細節與電影級光影。 
整體風格：史詩感、寫實、電影級構圖、AAA遊戲概念藝術、高品質3D立體感、強烈空間透視、自然大氣透視、電影級光影、沉浸式視覺效果。
```
