...
### 平面設計
```
平面設計 1920x1080 image 0.文案 [] 信息集中在人物左右,底部不多 1.人物 [用陰影增加層次感] 2.背景 [打光,金屬紋路,提取角色颜色调整渐变叠加] 3.文字 [人物名字加大放在人物背後,文字顏色漸變] 4.人物元素+左中右下 [小表情] 5.焦點 [结构暗示：整体排版构成形状为拱形，暗示结构。重心集中在上半部分]
```
